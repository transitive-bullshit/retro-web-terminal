...
- **React, Zod, DialKit, Motion, Vite, tsdown, @vercel/analytics:** MIT dependencies. Their package license files remain with their installed distributions. The browser shell and controls are demo dependencies only.
